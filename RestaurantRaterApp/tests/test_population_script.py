...
class PopulationScriptTests(TestCase):
    ...
    def test_likes(self):
        ...
        self.assertTrue(Restaurant.objects.get(restaurant_id="ALC") in user_client.objects.get(name="Colin").liked_restaurants.all(), msg)
    
    def test_rates_adds_rating(self):
    ...
    def test_owns_restaurant_added(self):
        ...
        self.assertTrue(Restaurant.objects.get(restaurant_id="ALC") in user_client.objects.get(name="Danny").owned_restaurants.all(), msg)
    ...
    def test_correct_users_created(self):
        ...
        usernames = ["Mark.E", "Thom.O", "Matt.W", "Michael.G", "Andy.P", "Rose.S", "Jeremy.S", "Jeff.D", "Colin", "Nicola.H", "Danny.M"]
